...
//     // We remove media_assets and file as they are not columns
//     const { media_assets, file, ...dbData } = logoToSave;
...
//   if (logoData.file) {
//     const { data: newMediaAsset, error } = await uploadMediaAsset(logoData.file, userId);
//     if (error) throw error;
